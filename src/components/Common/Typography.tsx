...
export const Heading: React.FC<HeadingProps> = ({
  ...
  const baseClasses: Record<'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6', string> = {
    h1: 'text-[2.25rem] leading-[2.25rem] md:text-[3.5rem] md:leading-[3.75rem] font-family-helvetica-condensed font-bold',
    h2: 'text-[1.5rem] leading-[1.8rem] md:text-[2.5rem] md:leading-[3rem] font-family-helvetica-condensed font-bold',
    h3: 'text-[1.25rem] leading-[1.5rem] md:text-[1.5rem] md:leading-[1.8rem] font-family-helvetica-condensed font-bold',
    h4: 'text-[1rem] leading-[1.25rem] md:text-[1.125rem] md:leading-[1.35rem] font-family-helvetica-condensed font-bold',
    h5: 'text-[0.874rem] leading-[1.3125rem] md:text-[1.125rem] md:leading-[2.025rem] font-family-poppins font-semibold',
    h6: 'text-[0.875rem] leading-[1.3125rem] md:text-[1rem] md:leading-[1.125rem] font-family-poppins font-semibold',
  };
...
export const SubHeading: React.FC<SubHeadingProps> = ({
  ...
  const baseClasses: Record<'sh1', string> = {
    sh1: 'text-[0.875rem] leading-[1.3125rem] md:text-[1.125rem] md:leading-[2.0625rem] font-family-poppins font-normal'
  };
...
export const BodyText: React.FC<BodyProps> = ({
  ...
  const baseClasses: Record<'big' | 'medium' | 'mediumbold' | 'regular' | 'small' | 'small-medium' | "trimmed" | 'small-trimmed', string> = {
    big: 'text-[1rem] md:text-[2.25rem] leading-[1.5rem] md:leading-[3rem] tracking-0 font-medium',
    medium: 'text-[0.875rem] leading-[1.3125rem] md:text-[1rem] md:leading-[1.6rem] tracking-0',
    mediumbold: 'text-[0.875rem] leading-[1.3125rem] md:text-[1rem] md:leading-[1.125rem] tracking-0 font-bold',
